function [xy_data] = sm_extr_data_ring(ring_or, ring_ir, deg1, deg2, varargin)
%sm_extr_data_ring Produce extrusion data for a ring.
%   [xy_data] = sm_extr_data_ring(ring_or, ring_ir, deg1, deg2)
...
%   >> sm_extr_data_ring(10,5,45,315,'plot')
...
if (nargin == 0 || strcmpi(showplot,'plot'))
    ...
    title(['[xy\_data] = sm\_extr\_data\_ring(ring\_or, ring\_ir, deg1, deg2);']);
    hold off
    box on
    clear xy_data
end
