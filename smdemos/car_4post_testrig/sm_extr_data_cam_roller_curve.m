function [xy_data] = sm_extr_data_cam_roller_curve(cam_xsec,roller_rad,inout,varargin)
%sm_extr_data_cam_roller_curve Produce curve data for a constraint that holds
%a circular roller to an arbitrary cam profile
%   [xy_data] = sm_extr_data_cam_roller_curve(cam_xsec,roller_rad,inout)
...
%   >> sm_extr_data_cam_roller_curve
%
%   To see a plot created with your parameter values,
%   add 'plot' as the final argument
%   >> sm_extr_data_cam_roller_curve([sind(1:4:360)' 1.5*cosd(1:4:360)'],0.2,'Outside','plot')
...
if (nargin == 0 || strcmpi(showplot,'plot'))
    ...
    title('[xy\_data] = sm\_extr\_data\_cam\_roller\_curve(cam\_xsec,roller\_rad,inout);');
