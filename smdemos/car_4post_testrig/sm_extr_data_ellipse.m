function [xy_data] = sm_extr_data_ellipse(a, b, deg1, deg2, ctr, varargin)
%sm_extr_data_ellipse Produce extrusion data for an ellipse.
%   [xy_data] = sm_extr_data_ellipse(a, b, deg1, deg2, ctr, varargin)
...
%   >> sm_extr_data_ellipse
%
%   To see a plot created with your parameter values,
%   add 'plot' as the final argument
%   >> sm_extr_data_ellipse(5,2,60,315,1,'plot')
...
if (nargin == 0 || strcmpi(showplot,'plot'))
    ...
    title(['[xy\_data] = sm\_extr\_data\_ellipse(a, b, deg1, deg2, ctr);']);
    hold off
    box on
    clear xy_data
end
