function [xy_data] = sm_extr_data_pulley(rad_p, h_grv, rad_h, a_grv, th_p,  varargin)
%sm_extr_data_pulley Produce *revolution* data for a pulley.
%   [xy_data] = sm_extr_data_pulley((rad_p, h_grv, rad_h, a_grv, th_p)
...
%   >> sm_extr_data_pulley(0.025,0.005,0.005,25,0.02,'plot')
