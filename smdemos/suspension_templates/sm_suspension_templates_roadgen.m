function P = sm_suspension_templates_roadgen( u )
%SM_SUSUPENSION_TEMPLATES_ROADGEN This block generates test road profiles for 
%the left and right tires. A road profile is comprised of the following:
% 
