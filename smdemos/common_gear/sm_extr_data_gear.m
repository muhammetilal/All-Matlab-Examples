function [xy_data] = sm_extr_data_gear(type, Dp, N, radh, varargin)
...
%   [xy_data] = sm_extr_data_gear(type, Dp, N, radh, varargin)
...
%   >> sm_extr_data_gear
%   >> sm_extr_data_gear('internal')
%
%   To see a plot created with your parameter values,
%   add 'plot' as the final argument
%   >> sm_extr_data_gear('internal',0.25, 20, 0.01, 'plot')
